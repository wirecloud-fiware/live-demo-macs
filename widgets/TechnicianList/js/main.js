...
/*global window, document, console, MashupPlatform, Vcard, StyledElements*/
...
/***********************************************************************************/
    ...
    var resize = function resize (technician) {
        if (this.table) {
            this.table.repaint();
        }
    };
...
/***********************************************************************************/
    ...
    var handlerContextHeight = function handlerContextHeight () {
        resize.call(this);
    };

    var handlerContextWidth = function handlerContextWidth () {
        resize.call(this);
    };
    ...
    window.TechnicianList = TechnicianList;
