...
/**************************************************************************/
    ...
    var createTable = function createTable () {
        var columns = [
            ...
            {field:"imageComment", label:"Description", width: "300px", sortable: true},
...
/**************************************************************************/
    ...
    var handlerClickRow = function handlerClickRow (observationFromTable) {
        var observation, idToSearch = observationFromTable.id, found = false, i = 0;
        ...
        MashupPlatform.wiring.pushEvent('observationOutput', JSON.stringify(observation));
    };
