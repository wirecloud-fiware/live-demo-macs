 ...
 *
 *     This file is part of the vcard2poi widget.
 *
...
MashupPlatform.wiring.registerCallback("inputVcard", function(vCardString) {
    ...
    poi.icon = ownUrl.call(this, "images/van.png");
...
var setInfoWindow = function setInfoWindow (vCard) {
    var infoWindow = "<div>";
    infoWindow += "<span><b>Name:</b> " + vCard.getValue('FN', 0) + "</span>";
    infoWindow += "<br />";
    infoWindow += "<span><b>Mobile Phone:</b> " + vCard.getValue('TEL', 0) + "</span>";
    infoWindow += "</div>";
    return infoWindow;
};
